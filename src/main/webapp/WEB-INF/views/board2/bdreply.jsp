...
<body>
<form action="bdresave" method="post">
<input type="hidden" name="bnum" value="${dto2.bnum}">
<input type="hidden" name="groups" value="${dto2.groups}">
<input type="hidden" name="step" value="${dto2.step}">
<input type="hidden" name="indent" value="${dto2.indent}">
